...
export async function POST(req: Request) {
  ...
  if (eventType === 'user.created' || eventType === 'user.updated') {
    const { id, email_addresses, first_name, last_name, phone_numbers, image_url, public_metadata } = evt.data
  ...
  if (eventType === 'user.deleted') {
    ...
    try {
      ...
      // You might want to find user by a clerkId field if you add one

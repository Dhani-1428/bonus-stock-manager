  ...
  const content = (
    <main className="min-h-screen bg-gradient-to-br from-background via-background to-background/95 flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <motion.div
          className="absolute top-1/3 right-1/3 w-96 h-96 bg-primary/10 rounded-full blur-3xl"
          animate={{
            scale: [1, 1.2, 1],
            opacity: [0.3, 0.5, 0.3],
          }}
        ...
        />
        <motion.div
          className="absolute bottom-1/4 left-1/4 w-80 h-80 bg-primary/8 rounded-full blur-3xl"
          animate={{
            scale: [1.2, 1, 1.2],
            opacity: [0.4, 0.6, 0.4],
          }}
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        {/* Clerk Sign Up with enhanced styling */}
        {clerkKey ? (
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            ...
            <SignUp
              appearance={{
                ...
                elements: {
                  ...
                  headerSubtitle: "text-sm text-white/70 mb-6",
                  socialButtonsBlockButton: "h-12 rounded-xl bg-secondary/50 hover:bg-secondary/70 text-white border border-primary/50 transition-all duration-200 hover:scale-[1.02] hover:shadow-lg",
                  ...
                  formFieldInput: "h-12 rounded-xl bg-background/50 border-2 border-primary/50 text-white placeholder:text-white/40 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all duration-200",
                  formButtonPrimary: "h-12 rounded-xl bg-gradient-to-r from-primary to-primary/90 text-white font-semibold shadow-lg hover:shadow-primary/20 hover:scale-[1.02] transition-all duration-200",
                  formFieldInputShowPasswordButton: "text-white/70 hover:text-white",
                  footerActionLink: "text-primary hover:text-primary/80 font-medium transition-colors text-white",
                  footer: "mt-6 pt-6 border-t border-primary/30",
                  formResendCodeLink: "text-primary hover:text-primary/80 text-white",
                  identityPreviewEditButton: "text-primary hover:text-primary/80 text-white",

            ...
            <SignUp
              appearance={{
                ...
                elements: {
                  ...
                  socialButtonsBlockButton: "h-12 rounded-xl bg-secondary/50 hover:bg-secondary/70 text-white border-2 border-primary transition-all duration-200 hover:scale-[1.02] hover:shadow-lg",
                  ...
                  formFieldInput: "h-12 rounded-xl bg-background/50 border-2 border-primary text-white placeholder:text-white/40 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all duration-200",
